  ...
  <main class="article-container m-auto flex justify-between">
    <div class="w-2/3 px-4 py-4">
      <div class="flex items-center justify-start gap-8 pb-4">
        <button class="text-xl" @click="$router.back()">
          <svg
        ...
        <h1 class="font-bold text-3xl">创建文章</h1>
      </div>

      <label for="create-article-title" class="text-xl inline-block pb-1"
      ...
      <input
        ...
        class="w-full border-2 text-lg px-1 py-1 rounded-md border-gray-400 bg-white"
      />
      <br />
      <label for="create-article-title" class="inline-block pt-4 text-xl pb-1"
        >内容<span class="text-red-500">*</span></label
      >
      <MarkdownEditor />
    </div>
    <div class="w-1/3 px-1 py-4 flex flex-col gap-4">
      <button class="block w-full text-xl font-bold border-2 rounded-md py-2">
        保存草稿
      </button>
      <button
        class="block w-full text-xl font-bold border-2 rounded-md py-2 bg-blue-500 text-white"
      >
        发布
      </button>
      <p>您的文章当前<a>处于隐藏状态</a></p>
      <div class="flex gap-2">
        <input type="checkbox" id="mature" />
        <label for="mature" class="font-bold"
          >成熟
      ...
      <div>
        <p class="text-xl inline-block pb-1">
      ...
      <div class="relative">
        <label for="select-category" class="text-xl inline-block pb-1"
          >标题<span class="text-red-500">*</span></label
        >
        <select
        ...
        <span class="absolute right-4 bottom-3">
          <svg
            class="icon"
