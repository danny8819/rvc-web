<template>
    <div class="rvc-card rvc-article-author  justify-space-around">
        ...
        <div class="main">
            ...
            <el-rate class="rate mt-4" v-model="rate" disabled show-score text-color="#FFFFFF" score-template="1.5k" />
            <div class="mt-4 mb-4">
                <div class="flex emojis ">
                    <span v-for="item in emojis" :key="item.emoji" class="ml-2 mr-1 flex w-2">
                        <SvgIcon :name="item.emoji" class="emoji" size="15" /> <span class="number ml-1">
                            {{
